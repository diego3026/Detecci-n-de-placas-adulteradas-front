# Form implementation generated from reading ui file 'ui/log_window.ui'
#
...
"font: 9pt \"MS Shell Dlg 2\";")
        ...
        self.total_registros = QtWidgets.QLabel(parent=self.frame_11)
        self.total_registros.setStyleSheet("color: rgb(0, 0, 0);\n"
"font: 10pt \"MS Shell Dlg 2\";")
        self.total_registros.setObjectName("total_registros")
        self.verticalLayout_7.addWidget(self.total_registros)
...
"color: rgb(3, 182, 107);")
        ...
        self.numeros_exitos = QtWidgets.QLabel(parent=self.frame_10)
        self.numeros_exitos.setStyleSheet("color: rgb(0, 0, 0);\n"
"font: 10pt \"MS Shell Dlg 2\";")
        self.numeros_exitos.setObjectName("numeros_exitos")
        self.verticalLayout_8.addWidget(self.numeros_exitos)
        self.horizontalLayout_4.addWidget(self.frame_10)
        self.frame_9 = QtWidgets.QFrame(parent=self.frame_8)
        self.frame_9.setStyleSheet("background-color: rgb(235, 235, 235);\n"
"border:none;")
        ...
        self.label_8.setStyleSheet("color: rgb(255, 58, 68);\n"
"font: 9pt \"MS Shell Dlg 2\";")
        self.label_8.setObjectName("label_8")
        self.verticalLayout_9.addWidget(self.label_8)
        self.numero_errores = QtWidgets.QLabel(parent=self.frame_9)
        self.numero_errores.setStyleSheet("color: rgb(0, 0, 0);\n"
"font: 10pt \"MS Shell Dlg 2\";")
        self.numero_errores.setObjectName("numero_errores")
        self.verticalLayout_9.addWidget(self.numero_errores)
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "CENTRO DE ACTIVIDADES"))
        self.label_5.setText(_translate("Form", "Superuser"))
        self.label_4.setText(_translate("Form", "Administrador"))
        self.label_2.setText(_translate("Form", "Aquí puedes consultar los registros de la aplicación."))
        self.label_7.setText(_translate("Form", "Total de registros"))
        self.total_registros.setText(_translate("Form", "4"))
        self.label_6.setText(_translate("Form", "Operaciones exitosas"))
        self.numeros_exitos.setText(_translate("Form", "3"))
        self.label_8.setText(_translate("Form", "Errores del sistema detectados"))
        self.numero_errores.setText(_translate("Form", "1"))
